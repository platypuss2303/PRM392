...
fun BottomNavigation(navHostController: NavHostController,
    ...
    val items = listOf(
        NavigationItem(name = "Chats",  R.drawable.chat_icon,  R.drawable.outline_chat_24),
        NavigationItem(name = "Update", R.drawable.update_icon, R.drawable.update_icon),
        NavigationItem(name = "Communities",  R.drawable.baseline_groups_24,  R.drawable.outline_groups_24),
        NavigationItem(name = "Phone",  R.drawable.telephone, R.drawable.outline_phone_24)
    ...
    NavigationBar(containerColor = Color.White, modifier = Modifier.height(80.dp)) {
        items.forEachIndexed {
            ...
            NavigationBarItem(
                ...
                , contentDescription = null, tint = if(index == selectedItem){
                    Color.DarkGray
                }else{
                    Color.Black
